...
{
    public sealed partial class UserMapList : UserControl
    {
        public UserMapList()
        {
            this.InitializeComponent();
            RemoveAnnimation.Completed += RemoveAnnimation_Completed;
            DataContextChanged += UserMapList_DataContextChanged;
        }

        private void UserMapList_DataContextChanged(FrameworkElement sender, DataContextChangedEventArgs args)
        {
